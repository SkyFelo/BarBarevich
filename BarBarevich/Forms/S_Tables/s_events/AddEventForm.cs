...
namespace BarBarevich.Forms.S_Tables.s_activity_type
{
    public partial class AddEventForm : Form
    {
        ...
        public AddEventForm(EventForm lastForm)
        {
            InitializeComponent();
        ...
        {
            textBoxID.Text = eventsClass.GetEventMaxId();
        }
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Мероприятие " + name + " уже добавлено в справочник.", 
                    "Ошибка", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }

            eventsClass.AddEvent(id, name);
        ...
        protected override bool ProcessCmdKey(ref Message msg, Keys keyData)
        {
            if (keyData == Keys.F1)
            {
                HelpManager.ShowHelp(nameof(AddEventForm));
                return true;
            }
